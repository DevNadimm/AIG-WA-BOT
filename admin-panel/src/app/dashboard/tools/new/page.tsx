...
export default function NewToolPage() {
  ...
  const [params, setParams] = useState([{ name:"", param_type:"string", description:"", is_required: true }]);
  ...
  return (
    <div className="space-y-6 pb-12">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-zinc-100">Create New Tool</h1>
          <p className="text-zinc-400 text-sm mt-1">Define a new REST API tool for AI Agents</p>
        </div>
      </div>
          ...
          <CardContent className="space-y-8 pt-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="col-span-2">
                <Input id="name" name="name" required placeholder="e.g. check_availability" className="bg-[#121214] border-zinc-700 text-zinc-100" />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="col-span-2">
                <Textarea 
                  id="description" 
                  name="description" 
                  placeholder="Fetches doctor availability based on specialization..." 
                  rows={4} 
                  required 
        ...
        <Card className="border-zinc-800 bg-[#0c0c0e] mt-6">
          ...
          <CardContent className="space-y-8 pt-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="col-span-2">
                <Input id="endpoint" name="endpoint" required placeholder="https://api.hospital.com/v1/availability" className="bg-[#121214] border-zinc-700 text-zinc-100 font-mono" />
              </div>
            </div>
          </CardContent>
        </Card>
                  ...
                  <div className="grid grid-cols-4 gap-4 flex-1">
                    ...
                    <div className="space-y-1 col-span-2">
                      ...
                      <Input 
                        ...
                        placeholder="Explain this param to AI..." 
                        className="h-8 bg-zinc-900 border-zinc-700 text-zinc-200" 
                      />
                    </div>
                  </div>
